<div class="main-header">
                ...
                <nav id="mobile-menu-01" class="mobile-menu collapse">
                    <ul id="mobile-primary-menu" class="menu">
                        <li class="menu-item">
                            <a href="index.php">trip planner</a>
                        </li>
                        <li class="menu-item">
                            <a href="discovery.php">discovery</a>
                        </li>
                        <li class="menu-item">
                            <a href="iitineraries.php">itineraries</a>
                    ...
                    <ul class="mobile-topnav container">
                        ...
                        <li class="ribbon language menu-color-skin">
                            <a href="#" data-toggle="collapse">en</a>
                            <ul class="menu mini">
                                <li class="active"><a href="#" title="english">english</a></li>
                                <li><a href="#" title="indonesia">bahasa</a></li>
                            </ul>
                        </li>
                        <li><a href="#travelo-login" class="soap-popupbox">log in</a></li>
