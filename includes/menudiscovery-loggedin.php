...
<div class="topnav hidden-xs" style="background-color:#fff; height:75px;">
    <div class="container">
            ...
            <li><a href="index.php" style="color: #636363; padding: 0px 17px 0px 17px;">trip planner</a></li>
            <li><a href="discovery.php" style="border:2px solid #636363; color: #636363; border-radius:30px; padding: 2px 17px 0px 17px;">discovery</a></li>
