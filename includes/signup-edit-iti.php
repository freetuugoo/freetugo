...
<?php
    ...
    if(isset($_POST['signup-edit-iti'])){
...
?>
<div id="travelo-signup-edit-iti" class="travelo-login-box travelo-box" style="width:870px; padding:0px;">
                <table>
                    <tr>
                        <td>
                ...
                <div class="email-signup">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" onclick="redirect(target)" class="full-width btn-medium" name="signup-edit-iti" style="border-radius:30px; background: #0095da; padding: 10px 30px 40px 30px; font-size:15px; font-weight:600">Sign up</button>
                        <!-- <?php
                        ...
                        ?> -->
                            ...
                            <a href="#travelo-login-edit-iti" class="goto-login soap-popupbox"><b>Log in here</b></a>
                            </p>
                        </td>
                    </tr>
                </table>
